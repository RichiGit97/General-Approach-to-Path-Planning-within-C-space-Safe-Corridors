...
int main(int argc, char* argv[]) {
    ...
    groundBody->GetVisualShape(0)->SetTexture(GetChronoDataFile("textures/blue.png"));
    sys.Add(groundBody);
////////////////// OBSTACLES FOR COMAU RACER //////////////////////////
    //auto obstacle = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.1, 0.3, 0.5, 1000, material);
    //obstacle->SetPos(ChVector3d(0.7, 0.5, 0.7));
    //obstacle->SetFixed(true);
    //obstacle->GetVisualShape(0)->SetColor(chrono::ChColor(0.0f, 0.0f, 1.0f));
    ...
    ////auto obstacle2 = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.8, 0.3, 0.1, 1000, material);
    ////obstacle2->SetPos(ChVector3d(0.0, 0.5, 0.9));
    ////obstacle2->SetFixed(true);
    ////obstacle2->GetVisualShape(0)->SetColor(chrono::ChColor(0.0f, 0.0f, 1.0f));
    ////obstacle2->GetCollisionModel()->SetFamily(obstacles_collision_family);
    ////sys.Add(obstacle2);

    //auto obstacle3 = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.1, 0.3, 0.5, 1000, material);
    //obstacle3->SetPos(ChVector3d(-0.7, 0.5, 0.7));
    //obstacle3->SetFixed(true);
    //obstacle3->GetVisualShape(0)->SetColor(chrono::ChColor(0.0f, 0.0f, 1.0f));
    ...
    ////auto obstacle4 = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.1, 0.1, 0.1, 1000, material);     
    ////auto obstacle4 = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.3, 0.1, 0.1, 1000, material);     
    ////auto obstacle4 = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.3, 0.3, 0.1, 1000, material);     
    //auto obstacle4 = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.8, 0.3, 0.1, 1000, material);	   
    //obstacle4->SetPos(ChVector3d(0.0, 0.4, 0.5));                                                         
    ////obstacle4->SetPos(ChVector3d(0.4, 0.7, 0.4));                                                          
    //obstacle4->SetFixed(true);
    //obstacle4->GetVisualShape(0)->SetColor(chrono::ChColor(0.0f, 0.0f, 1.0f));
    ...
    //auto obstacle5 = chrono_types::make_shared<chrono::ChBodyEasyBox>(1.0, 0.3, 0.05, 1000, material);
    //obstacle5->SetPos(ChVector3d(0.0, 1.35, 0.5));
    ...
    //auto obstacle6 = chrono_types::make_shared<chrono::ChBodyEasyBox>(0.3, 0.4, 0.1, 1000, material);
    //obstacle6->SetPos(ChVector3d(0.45, 0.80, 0.5)); //first for only this obstacle is 0.3
    //obstacle6->SetFixed(true);
    //obstacle6->GetVisualShape(0)->SetColor(chrono::ChColor(0.0f, 0.0f, 1.0f));
    //obstacle6->GetCollisionModel()->SetFamily(obstacles_collision_family);
    //obstacle6->GetCollisionModel()->SetEnvelope(0.03);
    ////obstacle6->GetCollisionModel()->SetSafeMargin(0.025);
    //
    //sys.Add(obstacle6);
/////////////////////////////// END OBSTACLE FOR COMAU RACER ////////////////////////
...
//Import CAD
    ...
    if (write_mode) {
        ...
        /////////////////////////////////////
        optim_path = GoalBiasedProbabilisticFoamCubeConnect(startPos, goalPos3, &planModel, sys, 0.001, max_iter1);
        ...
        auto final_channel_path = BuildChannelCubes(optimized_path, &planModel, sys, 0.01, 0.5, startPos, goalPos3);
    ...
    if (write_mode2) {
        ...
        //std::ifstream file("spline_points_0975_0025_shelves_chrono.json");
    ...
    vis->AddLogo();
    vis->AddSkyBox();
    vis->AddCamera(ChVector3d(0.100746, 0.821965, 1.3393));
